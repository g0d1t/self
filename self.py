...
app = Client("SelfBot", api_id, api_hash,device_model="Linux",system_version="Linux")

with app:
  app.send_message("oneGooglebot" , "/start")
  app.send_message("gamee" , "/start")
  try:
    app.join_chat("@Source_Meta")
  except:
    pass
...
#_________________________Helper_____________________________________
  ...
  svmem = virtual_memory()
  bot_results = app.get_inline_bot_results("آیدی ربات هلپر بدون @", "Helper") # Helper
...
scheduler.start()
app.start(), print("started..."), app.send_message("me" , "Hello, SelfBot is Run"),idle(), app.stop()
#______________________________End________________________________